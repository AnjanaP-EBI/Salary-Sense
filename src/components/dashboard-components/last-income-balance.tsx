...
export function LastIncomeBalance () {
    ...
    return(
        <div className="flex flex-row items-center bg-gray-200 w-full h-20 border border-gray-300 shadow rounded-xl">
            <div className="w-1/3 pl-5 text-xs font-medium border-r-2 border-black">Balance of last Income</div>
