    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-between justify-between h-full">
          {/*menu items */}
          <div>
            <div className="p-4 flex flex-row items-center gap-5 hover:bg-blue-50 hover:border-r-5 hover:border-blue-600 ">
            ...
            <div className="p-4 flex flex-row items-center gap-5 hover:bg-blue-50 hover:border-r-5 hover:border-blue-600"><IoBugSharp size={22}/>
              Report a Bug
            </div>
            <Separator/>
          ...
          <div>
            ...
            <div className="flex flex-col justify-center items-center py-4 w-full rounded-br-xl text-md font-semibold hover:bg-blue-100" 
