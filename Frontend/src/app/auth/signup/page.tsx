  ...
  return (
    <div className="w-full h-screen flex flex-row  align-middle ">
      ...
      <div className="w-1/2 p-10 flex flex-col items-center justify-center">
        ...
        />
        <Input
          className="bg-white w-4/5 h-12 mb-4 rounded-full placeholder:text-xs"
          type="password"
          placeholder="Confirm Password"
        />
        <Button className="bg-blue-600 rounded-full mb-4 hover:bg-gray-400 hover:text-black" size="lg">
          Sign Up
        </Button>
